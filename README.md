# Salt Extension for Netbox

Salt Extension for interacting with Netbox
...
The saltext-netbox project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:AllenRDCo/saltext-netbox.git
...
* Writing blog posts
* Sharing your experiences using Salt + Netbox
  on social media
...
[issues]: https://github.com/AllenRDCo/saltext-netbox/issues
[PRs]: https://github.com/AllenRDCo/saltext-netbox/pulls
[discussions]: https://github.com/AllenRDCo/saltext-netbox/discussions
